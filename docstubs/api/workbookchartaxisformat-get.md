...
-->
``` http
GET /me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/format
```
...
-->
``` http
GET https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/format
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.workbookChartAxisFormat",
    "id": "0ef1cf3f-cf3f-0ef1-3fcf-f10e3fcff10e"
  }
}
```
