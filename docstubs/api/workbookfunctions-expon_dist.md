...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/expon_Dist
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/expon_Dist
