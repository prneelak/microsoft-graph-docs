...
-->
``` http
GET https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}/rows/itemAt(index=5)
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.workbookTableRow",
    "id": "6a5a38c3-38c3-6a5a-c338-5a6ac3385a6a",
    "index": 5,
    "values": {
