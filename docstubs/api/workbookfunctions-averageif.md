...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/averageIf
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/averageIf
