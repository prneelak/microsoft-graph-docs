...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/priceMat
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/priceMat
