---
title: "Add managedAppPolicies"
description: "Add managedAppPolicies by posting to the managedAppPolicies collection."
author: ""
...
-->
``` http
POST /deviceAppManagement/managedAppPolicies/$ref
```
...
{
  "@odata.type": "#microsoft.graph.managedAppPolicy",
  "id": "885196a0-96a0-8851-a096-5188a0965188",
  "displayName": "Display Name value",
  "description": "Description value",
