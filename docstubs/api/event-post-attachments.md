...
-->
``` http
POST /me/messages/{messageId}/microsoft.graph.eventMessage/event/attachments/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/messages/{messageId}/microsoft.graph.eventMessage/event/attachments
...
{
  "@odata.type": "#microsoft.graph.attachment",
  "id": "5a5bd3be-d3be-5a5b-bed3-5b5abed35b5a",
