...
-->
``` http
GET https://graph.microsoft.com/localtest/education/classes/{educationClassId}/schools/{educationSchoolId}/users/{educationUserId}/schools
```
  ...
  "value": [
    {
      ...
      "id": "263b2393-2393-263b-9323-3b2693233b26",
