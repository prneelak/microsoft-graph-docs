...
-->
``` http
POST /me/contacts/{contactId}/multiValueExtendedProperties/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/contacts/{contactId}/multiValueExtendedProperties
