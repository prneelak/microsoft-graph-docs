---
title: "Update event"
description: "Update the properties of a event object."
author: ""
...
Update the properties of a [event](../resources/event.md) object.
...
PATCH /me/joinedTeams/{groupId}/events/{eventId}
PATCH /me/joinedTeams/{groupId}/calendarView/{eventId}
PATCH /me/messages/{messageId}/microsoft.graph.eventMessage/event
PATCH /me/messages/{messageId}/microsoft.graph.eventMessage/event/instances/{eventId}
PATCH /me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/events/{eventId}
PATCH /me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/calendarView/{eventId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/localtest/me/events/{eventId}
