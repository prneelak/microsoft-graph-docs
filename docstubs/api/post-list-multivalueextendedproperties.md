...
-->
``` http
GET https://graph.microsoft.com/localtest/me/joinedTeams/{groupId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/multiValueExtendedProperties
```
  ...
  "value": [
    {
      ...
      "id": "c1905024-5024-c190-2450-90c1245090c1",
      "value": [
        "Value value"
      ]
    }
