...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/xirr
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/xirr
