...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/imLog10
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/imLog10
