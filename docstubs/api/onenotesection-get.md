...
GET /me/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages/{onenotePageId}/parentSection
GET /me/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/parentSectionGroup/sections/{onenoteSectionId}
```
...
-->
``` http
GET https://graph.microsoft.com/localtest/me/onenote/sections/{onenoteSectionId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.onenoteSection",
    "id": "13b63f6a-3f6a-13b6-6a3f-b6136a3fb613",
    "self": "Self value",
