...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/t_Dist_2T
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/t_Dist_2T
