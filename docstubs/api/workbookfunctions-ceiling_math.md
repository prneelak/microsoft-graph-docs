...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/ceiling_Math
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/ceiling_Math
