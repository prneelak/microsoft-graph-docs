...
-->
``` http
POST /me/contacts/{contactId}/singleValueExtendedProperties/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/contacts/{contactId}/singleValueExtendedProperties
