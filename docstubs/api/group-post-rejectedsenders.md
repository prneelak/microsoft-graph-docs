---
title: "Add rejectedSenders"
description: "Add rejectedSenders by posting to the rejectedSenders collection."
author: ""
...
Add rejectedSenders by posting to the rejectedSenders collection.
...
POST /me/joinedTeams/{groupId}/rejectedSenders/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/groups/{groupsId}/rejectedSenders
