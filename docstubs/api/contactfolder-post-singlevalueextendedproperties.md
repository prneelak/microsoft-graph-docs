...
-->
``` http
POST /me/contactFolders/{contactFolderId}/singleValueExtendedProperties/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/contactFolders/{contactFolderId}/singleValueExtendedProperties
