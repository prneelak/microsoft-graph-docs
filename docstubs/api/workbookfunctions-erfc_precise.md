...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/erfC_Precise
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/erfC_Precise
