...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/mduration
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/mduration
