...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/skew_p
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/skew_p
