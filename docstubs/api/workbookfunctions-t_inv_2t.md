...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/t_Inv_2T
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/t_Inv_2T
