...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/mod
```
...
|divisor|[Json](../resources/json.md)||
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/mod
