...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/fisher
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/fisher
