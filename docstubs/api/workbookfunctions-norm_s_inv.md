...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/norm_S_Inv
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/norm_S_Inv
