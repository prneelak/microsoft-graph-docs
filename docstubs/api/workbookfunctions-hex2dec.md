...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/hex2Dec
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/hex2Dec
