...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/mround
```
...
|multiple|[Json](../resources/json.md)||
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/mround
