...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/intRate
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/intRate
