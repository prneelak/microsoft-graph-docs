...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/percentile_Inc
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/percentile_Inc
