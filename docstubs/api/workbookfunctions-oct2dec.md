...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/oct2Dec
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/oct2Dec
