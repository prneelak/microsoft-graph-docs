...
-->
``` http
GET https://graph.microsoft.com/localtest/me/joinedTeams/{groupId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/extensions
```
  ...
  "value": [
    {
      ...
      "id": "8da6bd7b-bd7b-8da6-7bbd-a68d7bbda68d"
    }
  ]
}
```
