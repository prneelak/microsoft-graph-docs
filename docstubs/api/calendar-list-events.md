...
-->
``` http
GET /me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/events
```
...
-->
``` http
GET https://graph.microsoft.com/localtest/me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/events
```
