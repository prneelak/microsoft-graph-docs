...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/percentRank_Inc
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/percentRank_Inc
