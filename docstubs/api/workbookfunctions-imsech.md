...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/imSech
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/imSech
