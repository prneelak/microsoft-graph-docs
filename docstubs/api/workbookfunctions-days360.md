...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/days360
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/days360
