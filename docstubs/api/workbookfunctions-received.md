...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/received
```
...
|investment|[Json](../resources/json.md)||
|discount|[Json](../resources/json.md)||
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/received
