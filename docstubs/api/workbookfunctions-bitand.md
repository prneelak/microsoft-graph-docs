...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/bitand
```
...
|:---|:---|:---|
|number1|[Json](../resources/json.md)||
|number2|[Json](../resources/json.md)||
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/bitand
