...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/chiSq_Dist
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/chiSq_Dist
