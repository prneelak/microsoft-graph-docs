...
-->
``` http
GET /me/drive/items/{driveItemId}/listItem/fields
GET /me/drive/items/{driveItemId}/listItem/versions/{listItemVersionId}/fields
```
...
-->
``` http
GET https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/listItem/fields
```
