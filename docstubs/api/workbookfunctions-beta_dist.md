...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/beta_Dist
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/beta_Dist
