...
-->
``` http
GET https://graph.microsoft.com/localtest/education/classes/{educationClassId}/schools/{educationSchoolId}/users/{educationUserId}/classes
```
  ...
  "value": [
    {
      ...
      "id": "9457bab8-bab8-9457-b8ba-5794b8ba5794",
