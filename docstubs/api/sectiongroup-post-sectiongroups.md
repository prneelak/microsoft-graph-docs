...
-->
``` http
POST /me/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/parentSectionGroup/sectionGroups/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/parentSectionGroup/sectionGroups
...
{
  "@odata.type": "#microsoft.graph.sectionGroup",
  "id": "9c856a38-6a38-9c85-386a-859c386a859c",
  "self": "Self value",
