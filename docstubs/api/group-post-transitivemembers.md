---
title: "Create transitiveMembers"
description: "Create transitiveMembers by posting to the transitiveMembers collection."
author: ""
...
# Create transitiveMembers

Namespace: microsoft.graph

Create transitiveMembers by posting to the transitiveMembers collection.
...
POST /me/joinedTeams/{groupId}/transitiveMembers/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/groups/{groupsId}/transitiveMembers
