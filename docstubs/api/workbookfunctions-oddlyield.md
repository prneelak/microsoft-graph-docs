...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/oddLYield
```
...
|lastInterest|[Json](../resources/json.md)||
|rate|[Json](../resources/json.md)||
|pr|[Json](../resources/json.md)||
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/oddLYield
