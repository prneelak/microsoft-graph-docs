---
title: "Add lists"
description: "Add lists by posting to the lists collection."
author: ""
...
Add lists by posting to the lists collection.
...
-->
``` http
POST /sites/{sitesId}/lists/$ref
POST /me/joinedTeams/{groupId}/sites/{siteId}/lists/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/sites/{sitesId}/lists
...
{
  "@odata.type": "#microsoft.graph.list",
  "id": "a7bd0224-0224-a7bd-2402-bda72402bda7",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet",
    "application": {
      "@odata.type": "microsoft.graph.identity",
