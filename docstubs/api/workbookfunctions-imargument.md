...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/imArgument
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/imArgument
