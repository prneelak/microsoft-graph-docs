...
-->
``` http
POST /shares/{sharesId}/items/$ref
POST /me/joinedTeams/{groupId}/sites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/items/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/shares/{sharesId}/items
