...
-->
``` http
POST /me/drive/items/{driveItemId}/workbook/functions/beta_Inv
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/drive/items/{driveItemId}/workbook/functions/beta_Inv
