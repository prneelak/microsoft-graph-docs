---
title: "Create directReports"
description: "Create directReports by posting to the directReports collection."
author: ""
...
# Create directReports

Namespace: microsoft.graph

Create directReports by posting to the directReports collection.
...
-->
``` http
POST https://graph.microsoft.com/localtest/contacts/{contactsId}/directReports
